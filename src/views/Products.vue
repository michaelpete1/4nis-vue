<template>
  <div class="bg-gray-900 text-white py-10">
    <div class="max-w-5xl mx-auto p-5">
      ...
      >
        <SwiperSlide v-for="product in products" :key="product.id" class="flex justify-center items-center">
          <div class="bg-gray-800 p-5 rounded-lg shadow-lg">
            <img :src="product.image" :alt="product.name" class="w-64 h-64 object-cover rounded-md mb-4" />
    ...
    <!-- New Section: Laptops & Accessories -->
